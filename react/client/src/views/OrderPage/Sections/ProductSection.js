...
export default function ProductSection() {
  ...
  return (
    <div className={classes.section}>
      ...
      <Button size="sm" color="rose" onClick={resetOrder} disabled={!costs}> send my order </Button>
      <Button size="sm" color="info" onClick={onClose}>cancel</Button>
      <Button size="sm" color="info" onClick={resetOrder}>reset</Button>
      </Drawer>
